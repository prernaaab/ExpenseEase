  ...
  return (
    <DashboardWrapper>
      ...
      <div className="flex flex-col items-start w-full">
        ...
        <div className="relative flex p-2 text-center w-full rounded-md font-semibold lg:w-[40dvw] text-lg md:text-xl bg-[rgb(237,240,246,1)]">
          <div
          ...
          <button
            className={`flex-1 py-1 w-full relative z-10 ${
        ...
        <div className="flex flex-col w-full md:w-[98%] mb-8 md:mb-14">
          <select
