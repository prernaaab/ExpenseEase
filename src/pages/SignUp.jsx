            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <button className="w-full flex items-center justify-center gap-4 py-3 bg-[#f3f9fa] rounded-xl hover:bg-[#e5f0f2] transition-colors">
                  <span className="text-secondary-text">Sign up with Google</span>
                </button>
                <button className="w-full flex items-center justify-center gap-4 py-3 bg-[#f3f9fa] rounded-xl hover:bg-[#e5f0f2] transition-colors">
                  <span className="text-secondary-text">Sign up with Apple</span>
                </button>
              </div>
            </div>
      ...
      <div className="flex md:hidden flex-col">
        <div className="py-6 bg-white inline-flex flex-col justify-start items-center gap-7 overflow-hidden">
          ...
          <div className="self-stretch h-[548px] px-6 flex flex-col justify-start items-start gap-6">
            ...
            <form onSubmit={handleSubmit(create)} className="self-stretch flex flex-col justify-center items-end gap-4">
              <Input
                label="Full Name"
                placeholder="Enter your name"
                type="mobile"
              ...
              <Input
                ...
                {...register("password", { required: true })}
              />
              <MainButton text="Create Account" type="mobile" className="self-stretch" />
            </form>
